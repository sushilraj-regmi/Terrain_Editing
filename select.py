...
polygon = [(127.14698761544736, 37.448164855223666),(127.14695560200964, 37.44816122976021), (127.14694592433774, 37.44822061702554),(127.1469845712283, 37.44822169252189)]
...
for i in range(len(polygon)):
    if i!= len(polygon)-1:
        cc= calculate_coordinates_along_line(polygon[i][0],polygon[i][1],polygon[i+1][0],polygon[i+1][1],6)
       
        for i in range(len(cc)):
            polygon1.append(cc[i])
    if i==len(polygon)-1:
        dd =calculate_coordinates_along_line(polygon[i][0],polygon[i][1],polygon[0][0],polygon[0][1],6)
        # polygon1.append()
